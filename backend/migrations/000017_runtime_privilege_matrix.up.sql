...
-- Verification query: SELECT has_table_privilege('pharmacycrm_runtime','pharmacycrm_schema_metadata','SELECT') AND NOT has_table_privilege('pharmacycrm_runtime','pharmacycrm_schema_metadata','INSERT,UPDATE,DELETE,TRUNCATE') AND has_table_privilege('pharmacycrm_runtime','inventory_movements','SELECT') AND has_table_privilege('pharmacycrm_runtime','inventory_movements','INSERT') AND NOT has_table_privilege('pharmacycrm_runtime','inventory_movements','UPDATE,DELETE,TRUNCATE') AND NOT has_table_privilege('pharmacycrm_runtime','audit_events','UPDATE,DELETE,TRUNCATE') AND NOT has_table_privilege('pharmacycrm_runtime','sales','UPDATE') AND has_column_privilege('pharmacycrm_runtime','sales','status','UPDATE');
